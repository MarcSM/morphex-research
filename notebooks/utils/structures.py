...
class Sound:
    def __init__(self, filepath=''):
        ...
        self.analysis = lambda:expando
        self.analysis.output = lambda:expando
        self.analysis.output.values = lambda:expando
        
        # Generating needed structure for the synthesis output data
        self.synthesis = lambda:expando
        self.synthesis.output = lambda:expando
        self.synthesis.output.values = lambda:expando
        self.synthesis.output.sines = lambda:expando
        self.synthesis.output.stochastic = lambda:expando
        self.synthesis.output.mixed = lambda:expando
