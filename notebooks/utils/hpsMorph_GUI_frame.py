...
import utils.hpsMorph_function as hM
...
def analysis(self):
    ...
    try:
        ...
        self.inputFile1, self.fs1, self.hfreq1, self.hmag1, self.stocEnv1,             self.inputFile2, self.hfreq2, self.hmag2, self.stocEnv2 = hM.analysis(inputFile1, window1, M1, N1, t1,             minSineDur1, nH, minf01, maxf01, f0et1, harmDevSlope1, stocf, inputFile2, window2, M2, N2, t2, minSineDur2, minf02, maxf02, f0et2, harmDevSlope2)
