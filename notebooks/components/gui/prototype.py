...
get_ipython().run_cell_magic('html', '', '<style>.widget-readout { color: white; font-size: 1.2em; } </style>') # style
...
def generate_morph(gui, sound_1, sound_2, sound_morph):
    ...
    try:
        ...
        hps.hpsMorphFrame(hfreq1, hmag1, stocEnv1, hfreq2, hmag2, stocEnv2, hfreqIntp, hmagIntp, stocIntp)
